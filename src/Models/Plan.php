...
use AbnDevs\Subscriptions\Traits\HasSubscriptionPeriod;
use AbnDevs\Subscriptions\Traits\HasTrialPeriod;
...
class Plan extends Model
{
    ...
    {
        return [
            'tag' => 'required|max:150|unique:' . config('laravel-subscriptions.tables.plans') . ',tag',
    ...
    {
        return $this->hasMany(config('laravel-subscriptions.models.plan_combination'), 'plan_id', 'id');
    }
