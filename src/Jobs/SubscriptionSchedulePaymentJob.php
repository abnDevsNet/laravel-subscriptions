...
namespace AbnDevs\Subscriptions\Jobs;
...
class SubscriptionSchedulePaymentJob implements ShouldQueue
{
    ...
    public function __construct($planSubscriptionScheduleId)
    {
        ...
        $paymentMethod = config('laravel-subscriptions.services.payment_methods.' . $this->planSubscriptionSchedule->subscription->payment_method);
