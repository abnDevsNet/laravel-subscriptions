...
trait HasSchedules
{
    ...
    {
        return $this->hasMany(config('laravel-subscriptions.models.plan_subscription_schedule'), 'subscription_id', 'id');
    }
     ...
     *
     * @return HasSchedules|\AbnDevs\Subscriptions\Models\PlanSubscription
     */
    ...
    public function getLatestSchedule(?Carbon $date = null)
    {
        ...
        return app(config('laravel-subscriptions.models.plan_subscription_schedule'))
            ->pending($date)
