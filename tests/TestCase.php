...
namespace AbnDevs\Subscriptions\Tests;
...
class TestCase extends \Orchestra\Testbench\TestCase
{
    ...
    {
        $app['config']->set('laravel-subscriptions', [
            ...
            'services' => [
                'payment_methods' => [
                    'success' => \AbnDevs\Subscriptions\Tests\Services\PaymentMethods\SucceededPaymentMethod::class,
                    'fail' => \AbnDevs\Subscriptions\Tests\Services\PaymentMethods\FailedPaymentMethod::class
                ]
            ]
        ]);
