...
use AbnDevs\Subscriptions\Jobs\SubscriptionRenewalPaymentJob;
use AbnDevs\Subscriptions\Jobs\SubscriptionSchedulePaymentJob;
use AbnDevs\Subscriptions\Services\PendingPaymentCollector;
...
class SubscriptionSchedulePaymentJobTest extends TestCase
{
    ...
    public function testSuccessfulJob()
    {
        ...
        $planSubscriptionSchedule = app(config('laravel-subscriptions.models.plan_subscription_schedule'))::find($pendingPayments[0]['collectable_id']);
