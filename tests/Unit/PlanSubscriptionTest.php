...
class PlanSubscriptionTest extends TestCase
{
    ...
    public function testAttachFeatureNotExistingInPlan()
    {
        ...
        $this->assertDatabaseHas(config('laravel-subscriptions.tables.plan_subscription_features'), [
    ...
    {
        $this->expectException('AbnDevs\Subscriptions\Exceptions\InvalidPlanSubscription');
    ...
    {
        Config::set('laravel-subscriptions.fallback_plan_tag', null);
    ...
    {
        Config::set('laravel-subscriptions.fallback_plan_tag', 'pro');
        $this->testUser->subscription('main')->cancel();
    ...
    {
        Config::set('laravel-subscriptions.fallback_plan_tag', 'super-pro');
